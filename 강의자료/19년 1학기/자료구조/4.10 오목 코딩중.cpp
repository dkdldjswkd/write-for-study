...
int main() {
	...
	while (1) { // 게임 와일문
		...
		int a = 0, b = 0;
		for (int i = 0; i <= 19; i++) { //윗 대각선(왼쪽 아래에서 오른쪽위) 흑돌이 연속인가
			a = i; b = 0;
			for (; a > 0; a--, b++) {
				if (a > 0) {
			...
			if (max > 1) {
				cout << "왼쪽 위부터 대각선의 이어진 흑돌의 갯수는 " << max << endl;
			}
			max = 0;
		}

		for (int i = 19; i >= 1; i--) { // 아래 대각선(왼쪽 아래에서 오른쪽위) 흑돌이 연속인가
			a = 18; b = i;
			for (; b < 19; a--, b++) {
				if (a > 0) {
					if (bord[a][b] == "○" && bord[a - 1][b + 1] == "○") {
			...
			if (max > 1) {
				cout << "오른쪽 아래부터 대각선의 이어진 흑돌의 갯수는 " << max << endl;
			}
			max = 0;
		}

		for (int i = 0; i <= 19; i++) { //윗 대각선(왼쪽 아래에서 오른쪽위) 백돌이 연속인가
			a = i; b = 0;
			for (; a > 0; a--, b++) {
				if (a > 0) {
					if (bord[a][b] == "●" && bord[a - 1][b + 1] == "●") {
			...
			if (max > 1) {
				cout << "왼쪽 위부터 대각선의 이어진 백돌의 갯수는 " << max << endl;
			}
			max = 0;
		}

		max = 0, a = 19, b = 19;
		for (int i = 19; i >= 1; i--) { // 아래 대각선(왼쪽 아래에서 오른쪽위) 백돌이 연속인가
			a = 18; b = i;
			for (; b < 19; a--, b++) {
				if (a > 0) {
					if (bord[a][b] == "●" && bord[a - 1][b + 1] == "●") {
			...
			if (max > 1) {
				cout << "오른쪽 아래부터 대각선의 이어진 백돌의 갯수는 " << max << endl;
			}
			max = 0;
		}

		max = 0;
		for (int i = 19; i >= 0; i--) { //윗 대각선(왼쪽 위에서 오른쪽 아래로) 흑돌이 연속인가
			a = 0; b = i;
			for (; b < 19; a++, b++) {
				if (b < 19) {
					if (bord[a][b] == "○" && bord[a + 1][b + 1] == "○") {
			...
			if (max > 1) {
				cout << "오른쪽 위부터 대각선의 이어진 흑돌의 갯수는 " << max << endl;
			}
			max = 0;
		}
		...
		for (int i = 19; i >= 1; i--) { // 아래 대각선(왼쪽 아래에서 오른쪽위) 흑돌이 연속인가
			...
			if (max > 1) {
				cout << "왼쪽 아래부터 대각선의 이어진 흑돌의 갯수는 " << max << endl;
			}
			max = 0;
		}

		for (int i = 19; i >= 0; i--) { //윗 대각선(왼쪽 위에서 오른쪽 아래로) 백돌이 연속인가
			a = 0; b = i;
			for (; b < 19; a++, b++) {
				if (b < 19) {
					if (bord[a][b] == "●" && bord[a + 1][b + 1] == "●") {
			...
			if (max > 1) {
				cout << "오른쪽 위부터 대각선의 이어진 백돌의 갯수는 " << max << endl;
			}
			max = 0;
		}
		...
		for (int i = 19; i >= 1; i--) { // 아래 대각선(왼쪽 아래에서 오른쪽위) 백돌이 연속인가
			...
			if (max > 1) {
				cout << "왼쪽 아래부터 대각선의 이어진 백돌의 갯수는 " << max << endl;
			}
			max = 0;
		}
